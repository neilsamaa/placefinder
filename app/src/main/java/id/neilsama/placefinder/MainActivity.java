package id.neilsama.placefinder;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // menu drop down untuk cari tempat
        ...
        spinnerCari.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (position == 1)
                    ...
                    xType = "tourist_attraction";
                else if (position == 5)
                    xType = "school";
                else if (position == 6)
                    xType = "local_government_office";
                if (position != 0) {
    ...
    // menjalankan fungsi pada parserplace class
    @SuppressLint("StaticFieldLeak")
